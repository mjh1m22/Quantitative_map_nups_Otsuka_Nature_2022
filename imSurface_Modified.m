function [surf labels] = imSurface_Modified(img, voxelSizeX, voxelSizeY, voxelSizeZ, varargin)
...
if ~islogical(img)
    ...
    for i = 1:nLabels
        ...
        surf(i) = imSurface_Modified(bin, voxelSizeX, voxelSizeY, voxelSizeZ, varargin{:});
    end
...
delta = [voxelSizeX voxelSizeY voxelSizeZ];
